...
{     
    public void Generate(Session session)
    {
        ...
        pert.settings.SetValue("vmr_angle", 0);
        pert.settings.SetValue("clamped_error", false);
        pert.settings.SetValue("timeout_period", 0.5);
        ...
        //deadapt.settings.SetValue("timeout_period", 2.0);
    }
}